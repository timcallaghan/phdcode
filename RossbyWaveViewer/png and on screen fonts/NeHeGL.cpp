...
// Define wheel mouse support...need to specify which windows version we are targeting
// Basically, should work for NT4.0 or greater
...
extern short	   zDelta;	// stores the mouse wheel rotation direction.
...
LRESULT CALLBACK WindowProc (HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	switch (uMsg)														// Evaluate Window Message
	{
        ...
        case WM_RBUTTONDOWN:
            isRClicked  = true;
            break;
		// Now check for mouse wheel movement
		case WM_MOUSEWHEEL:
...
{																		// TRUE If Successful
	...
	windowClass.hIcon			= (HICON)LoadImage(application->hInstance,MAKEINTRESOURCE(IDI_ICON1),IMAGE_ICON,0,0,LR_DEFAULTSIZE); // Set the icon
...
int WINAPI WinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	window.init.title			= "Rossby Wave Viewer";
