...
void pfield(double w, double Fr, double Ro, int kappa, double Ma, double gamma, double *eta, double *phi, double *H, int Hlen, double *y, int mm, int nn, double epsilon, double h0)
{
	...
	for (ii=0; ii<mm; ii++) {
		for (jj=0; jj<nn; jj++) 
		{
			...
			*(y+jj*mm+ii) = pow(temp1,gamma/(gamma-1.0));
		}
	}
                  ...
                  int nrhs, const mxArray *prhs[])
{
  ...
  pfield(w,Fr,Ro,kappa,Ma,gamma,eta,phi,H,Hlen,y,mrows,ncols,epsilon,h0); 
}
