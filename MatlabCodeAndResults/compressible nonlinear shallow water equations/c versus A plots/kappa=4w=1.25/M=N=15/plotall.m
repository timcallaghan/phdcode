...
% For kappa=5 w=1.25
lincval=(9.435084269911386e-001)*ones(1,NumDirects-StartDirect+1-numgaps);
...
plot(AmpsandC(2,1:95),AmpsandC(1,1:95),AmpsandC(2,1:95),AmpsandC(1,1:95),'rx');
plot(AmpsandC(2,96:end),AmpsandC(1,96:end),AmpsandC(2,96:end),AmpsandC(1,96:end),'rx');
...
grid on
% Plot each solution segment
plot(AmpsandC(2,1:95),AmpsandC(1,1:95));
plot(AmpsandC(2,96:end),AmpsandC(1,96:end));
% Put in linearised solution
plot(AmpsandC(2,:),lincval,'--');
% Label the figure
title('Wavespeed versus Equatorial Amplitude');
...
grid on
% Plot each solution segment
plot(AmpsandC(3,1:95),AmpsandC(1,1:95),AmpsandC(3,1:95),AmpsandC(1,1:95),'rx');
plot(AmpsandC(3,96:end),AmpsandC(1,96:end),AmpsandC(3,96:end),AmpsandC(1,96:end),'rx');
% Put in linearised solution
...
grid on
% Plot each solution segment
plot(AmpsandC(3,1:95),AmpsandC(1,1:95));
plot(AmpsandC(3,96:end),AmpsandC(1,96:end));
% Put in linearised solution
plot(AmpsandC(3,:),lincval,'--');
% Label the figure
title('Wavespeed versus Polar Amplitude');
...
grid on
% Plot each solution segment
plot(AmpsandC(4,1:95),AmpsandC(1,1:95),AmpsandC(4,1:95),AmpsandC(1,1:95),'rx');
plot(AmpsandC(4,96:end),AmpsandC(1,96:end),AmpsandC(4,96:end),AmpsandC(1,96:end),'rx');
% Put in linearised solution
...
grid on
% Plot each solution segment
plot(AmpsandC(4,1:95),AmpsandC(1,1:95));
plot(AmpsandC(4,96:end),AmpsandC(1,96:end));
% Put in linearised solution
plot(AmpsandC(4,:),lincval,'--');
% Label the figure
title('Wavespeed versus Combined Amplitude');
