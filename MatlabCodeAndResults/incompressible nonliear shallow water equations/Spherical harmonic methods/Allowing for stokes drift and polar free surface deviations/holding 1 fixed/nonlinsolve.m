...
% Hold the wavespeed fixed
fixed=3*M*M+1
% Adjust the nonlinear wavespeed so that it is slightly faster than the
% value calculated from the linearised theory (to make sure we are in a solution region)
coeffs(numunknowns+1,1)=(1.05)*lincoeffs(1,3*N+1);
