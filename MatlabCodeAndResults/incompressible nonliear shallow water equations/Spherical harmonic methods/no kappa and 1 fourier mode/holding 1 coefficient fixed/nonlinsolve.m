...
% shallow water coefficients. We include only 1 lot of Fourier basis functions
...
% The nonlinear series truncation level must be > kappa if we want to use the linear solution as a starting guess
if (N > kappa +1)
    M = N;
else
    M=kappa+1;
