...
AmpsandC=zeros(4,NumDirects-StartDirect+1);
...
for direct=StartDirect:NumDirects
    ...
    AmpsandC(1,direct-StartDirect+1)=c;
    AmpsandC(2,direct-StartDirect+1)=Ampe;
    AmpsandC(3,direct-StartDirect+1)=Ampp;
    AmpsandC(4,direct-StartDirect+1)=Ampt;
...
%lincval=(3.9519291252918765e-001)*ones(1,NumDirects-StartDirect+1);
% For kappa=5
%lincval=(1.579134708860227e+000)*ones(1,NumDirects-StartDirect+1);
lincval=(9.9307548016974279e-001)*ones(1,NumDirects-StartDirect+1);

% Now that we have all the data we do some plots
figure
hold on
grid on
plot(AmpsandC(2,:),AmpsandC(1,:),AmpsandC(2,:),AmpsandC(1,:),'rx',AmpsandC(2,:),lincval,'--');
