...
for direct=StartDirect:NumDirects
    ...
    if (direct == 35 | direct == 53 | direct == 73)
...
plot(AmpsandC(2,1:34),AmpsandC(1,1:34),AmpsandC(2,1:34),AmpsandC(1,1:34),'rx');
plot(AmpsandC(2,35:51),AmpsandC(1,35:51),AmpsandC(2,35:51),AmpsandC(1,35:51),'rx');
plot(AmpsandC(2,52:70),AmpsandC(1,52:70),AmpsandC(2,52:70),AmpsandC(1,52:70),'rx');
plot(AmpsandC(2,71:93),AmpsandC(1,71:93),AmpsandC(2,71:93),AmpsandC(1,71:93),'rx');
...
grid on
% Plot each solution segment
plot(AmpsandC(2,1:34),AmpsandC(1,1:34));
plot(AmpsandC(2,35:51),AmpsandC(1,35:51));
plot(AmpsandC(2,52:70),AmpsandC(1,52:70));
plot(AmpsandC(2,71:93),AmpsandC(1,71:93));
% Put in linearised solution
plot(AmpsandC(2,:),lincval,'--');
% Label the figure
title('Wavespeed versus Equatorial Amplitude');
...
grid on
% Plot each solution segment
plot(AmpsandC(3,1:34),AmpsandC(1,1:34),AmpsandC(3,1:34),AmpsandC(1,1:34),'rx');
plot(AmpsandC(3,35:51),AmpsandC(1,35:51),AmpsandC(3,35:51),AmpsandC(1,35:51),'rx');
plot(AmpsandC(3,52:70),AmpsandC(1,52:70),AmpsandC(3,52:70),AmpsandC(1,52:70),'rx');
plot(AmpsandC(3,71:93),AmpsandC(1,71:93),AmpsandC(3,71:93),AmpsandC(1,71:93),'rx');
% Put in linearised solution
...
grid on
% Plot each solution segment
plot(AmpsandC(3,1:34),AmpsandC(1,1:34));
plot(AmpsandC(3,35:51),AmpsandC(1,35:51));
plot(AmpsandC(3,52:70),AmpsandC(1,52:70));
plot(AmpsandC(3,71:93),AmpsandC(1,71:93));
% Put in linearised solution
plot(AmpsandC(3,:),lincval,'--');
% Label the figure
title('Wavespeed versus Polar Amplitude');
...
grid on
% Plot each solution segment
plot(AmpsandC(4,1:34),AmpsandC(1,1:34),AmpsandC(4,1:34),AmpsandC(1,1:34),'rx');
plot(AmpsandC(4,35:51),AmpsandC(1,35:51),AmpsandC(4,35:51),AmpsandC(1,35:51),'rx');
plot(AmpsandC(4,52:70),AmpsandC(1,52:70),AmpsandC(4,52:70),AmpsandC(1,52:70),'rx');
plot(AmpsandC(4,71:93),AmpsandC(1,71:93),AmpsandC(4,71:93),AmpsandC(1,71:93),'rx');
% Put in linearised solution
...
grid on
% Plot each solution segment
plot(AmpsandC(4,1:34),AmpsandC(1,1:34));
plot(AmpsandC(4,35:51),AmpsandC(1,35:51));
plot(AmpsandC(4,52:70),AmpsandC(1,52:70));
plot(AmpsandC(4,71:93),AmpsandC(1,71:93));
% Put in linearised solution
plot(AmpsandC(4,:),lincval,'--');
% Label the figure
title('Wavespeed versus Combined Amplitude');
