...
mval=0;
for nval=0:N
    T1=-2.0*kappa*a^2/Vzon*dblquad(@I1,0,pi/2,0,pi/kappa,jacintol,@adaptlob,x(2*M*N+1:numunknowns,1),M,N,kappa,a,nval,mval);
    T2=-4.0*kappa*a/Vzon*dblquad(@I2,0,pi/2,0,pi/kappa,jacintol,@adaptlob,x(2*M*N+1:numunknowns,1),M,N,kappa,a,nval,mval);
...
for mval=1:M-1
    for nval=1:N
        ...
        T2=-4.0*kappa*a/Vzon*dblquad(@I2,0,pi/2,0,pi/kappa,jacintol,@adaptlob,x(2*M*N+1:numunknowns,1),M,N,kappa,a,nval,mval);
        T3=-2.0*kappa/Vzon*dblquad(@I3,0,pi/2,0,pi/kappa,jacintol,@adaptlob,x(2*M*N+1:numunknowns,1),M,N,kappa,a,nval,mval);
        df(numunknowns,2*M*N+mval*N+nval+1)=T1+T2+T3;
    end
end
