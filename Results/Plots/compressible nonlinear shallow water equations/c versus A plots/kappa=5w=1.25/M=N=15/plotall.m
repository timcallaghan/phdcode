...
plot(AmpsandC(2,1:147),AmpsandC(1,1:147),AmpsandC(2,1:147),AmpsandC(1,1:147),'rx');
plot(AmpsandC(2,148:end),AmpsandC(1,148:end),AmpsandC(2,148:end),AmpsandC(1,148:end),'rx');
...
grid on
% Plot each solution segment
plot(AmpsandC(2,1:147),AmpsandC(1,1:147));
plot(AmpsandC(2,148:end),AmpsandC(1,148:end));
% Put in linearised solution
plot(AmpsandC(2,:),lincval,'--');
% Label the figure
title('Wavespeed versus Equatorial Amplitude');
...
grid on
% Plot each solution segment
plot(AmpsandC(3,1:147),AmpsandC(1,1:147),AmpsandC(3,1:147),AmpsandC(1,1:147),'rx');
plot(AmpsandC(3,148:end),AmpsandC(1,148:end),AmpsandC(3,148:end),AmpsandC(1,148:end),'rx');
% Put in linearised solution
...
grid on
% Plot each solution segment
plot(AmpsandC(3,1:147),AmpsandC(1,1:147));
plot(AmpsandC(3,148:end),AmpsandC(1,148:end));
% Put in linearised solution
plot(AmpsandC(3,:),lincval,'--');
% Label the figure
title('Wavespeed versus Polar Amplitude');
...
grid on
% Plot each solution segment
plot(AmpsandC(4,1:147),AmpsandC(1,1:147),AmpsandC(4,1:147),AmpsandC(1,1:147),'rx');
plot(AmpsandC(4,148:end),AmpsandC(1,148:end),AmpsandC(4,148:end),AmpsandC(1,148:end),'rx');
% Put in linearised solution
...
grid on
% Plot each solution segment
plot(AmpsandC(4,1:147),AmpsandC(1,1:147));
plot(AmpsandC(4,148:end),AmpsandC(1,148:end));
% Put in linearised solution
plot(AmpsandC(4,:),lincval,'--');
% Label the figure
title('Wavespeed versus Combined Amplitude');
