...
% For kappa=4
lincval=(9.4350842699113857e-001)*ones(1,NumDirects-StartDirect+1-numgaps);
...
plot(AmpsandC(2,1:84),AmpsandC(1,1:84),AmpsandC(2,1:84),AmpsandC(1,1:84),'rx');
plot(AmpsandC(2,85:end),AmpsandC(1,85:end),AmpsandC(2,85:end),AmpsandC(1,85:end),'rx');
...
grid on
% Plot each solution segment
plot(AmpsandC(2,1:84),AmpsandC(1,1:84));
plot(AmpsandC(2,85:end),AmpsandC(1,85:end));
% Put in linearised solution
plot(AmpsandC(2,:),lincval,'--');
% Label the figure
title('Wavespeed versus Equatorial Amplitude');
...
grid on
% Plot each solution segment
plot(AmpsandC(3,1:84),AmpsandC(1,1:84),AmpsandC(3,1:84),AmpsandC(1,1:84),'rx');
plot(AmpsandC(3,85:end),AmpsandC(1,85:end),AmpsandC(3,85:end),AmpsandC(1,85:end),'rx');
% Put in linearised solution
...
grid on
% Plot each solution segment
plot(AmpsandC(3,1:84),AmpsandC(1,1:84));
plot(AmpsandC(3,85:end),AmpsandC(1,85:end));
% Put in linearised solution
plot(AmpsandC(3,:),lincval,'--');
% Label the figure
title('Wavespeed versus Polar Amplitude');
...
grid on
% Plot each solution segment
plot(AmpsandC(4,1:84),AmpsandC(1,1:84),AmpsandC(4,1:84),AmpsandC(1,1:84),'rx');
plot(AmpsandC(4,85:end),AmpsandC(1,85:end),AmpsandC(4,85:end),AmpsandC(1,85:end),'rx');
% Put in linearised solution
...
grid on
% Plot each solution segment
plot(AmpsandC(4,1:84),AmpsandC(1,1:84));
plot(AmpsandC(4,85:end),AmpsandC(1,85:end));
% Put in linearised solution
plot(AmpsandC(4,:),lincval,'--');
% Label the figure
title('Wavespeed versus Combined Amplitude');
